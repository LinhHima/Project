    ...
    return (
        <CustomClass>
            ...
            <Button variant="contained" onClick={openCommonDialog} disabled={loadingCreate}>
                {loadingCreate ? <BeatLoader color="#fff" size={8} /> : "+ Add new game"}
            </Button>
            <Box py={1}></Box>
            ...
            <Typography className="title" onDoubleClick={openDialog}>
                Turn ticket:&nbsp;{<FormattedNumber value={turnPrice} />}&nbsp;VNĐ / 2h
            </Typography>
            <Typography className="title" onDoubleClick={openDialog}>
                Day ticket:&nbsp;{<FormattedNumber value={dayPrice} />}&nbsp;VNĐ / 1day
            </Typography>
            <Dialog
                onClose={closeDialog}
                open={open}
            ...
            >
                <DialogContent className="dialogContent">
                    ...
                    >
                        {loadingEditCommonPrice ? <BeatLoader color="#fff" size={8} /> : "Confirm Edit"}
                    </Button>
                </DialogContent>
            </Dialog>
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                <Box style={{ textAlign: "center" }}>
                                    <Button type="submit" disabled={loadingCreate} variant="contained">
                                        {loadingCreate ? <BeatLoader color="#fff" size={8} /> : "Confirm Create"}
                                    </Button>
                                </Box>
                            </Grid>
                        </Grid>
