        ...
        <CustomClass>
            <Box className="wrapper">
                ...
                <Box>
                    <Button variant="contained" onClick={openEditDialog} disabled={loadingEdit || loadingDelete}>
                        {loadingEdit || loadingDelete ? <BeatLoader color="#fff" size={8} /> : "Edit Game"}
                    </Button>
                    <span> </span>
                    <Button variant="contained" onClick={openDeleteDialog} disabled={loadingDelete}>
                        {loadingDelete ? <BeatLoader color="#fff" size={8} /> : "Delete Game"}
                    </Button>
                </Box>
            </Box>
            <Dialog
            ...
            >
                ...
                <DialogContent style={{ padding: "20px" }}>
                    ...
                    >
                        {loadingDelete ? <BeatLoader color="#fff" size={8} /> : "Confirm Delete"}
                    </Button>
                </DialogContent>
            </Dialog>
            <Dialog
