    ...
    return (
        <CustomClass>
            <Paper elevation={0} className="wrapper">
                <Typography style={{ color: "white", textAlign: "center", fontWeight: "bold", fontSize: "larger" }}>
                    VIP Management
                </Typography>
                <NormTextField
                    variant="outlined"
                                ...
                                if (
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <CellBody className="responsive">
                                                <Typography className="bodyTextCenter">{detail.point}</Typography>
                                            </CellBody>
                                            <CellBody className="responsive">
                ...
                {VIPAccounts.length == 0 && (
                    <Box py={3} textAlign="center">
                        <Empty color="white" title="There is no VIP Account" />
                    </Box>
                )}
            </Paper>
        </CustomClass>
