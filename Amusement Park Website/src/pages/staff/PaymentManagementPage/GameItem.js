                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={7}>
                        ...
                        <Typography className="gamePriceText">
                            {data.price != 0 ? (
                                <Typography>{<FormattedNumber value={data.price} />}&nbsp;VNĐ</Typography>
                            ) : (
                                "Free"
                            )}
                        </Typography>
                        ...
                        <Typography>
                            Price:&nbsp;
                            {data.price != 0 ? (
                                <span>{<FormattedNumber value={data.price * numberOfTicket} />}&nbsp;VNĐ</span>
                            ) : (
                                "Free"
                            )}
                        </Typography>
                        ...
                        <Button fullWidth onClick={handleBuyTicket} variant="contained" disabled={loading}>
                            {loading ? <BeatLoader color="#fff" size={8} /> : `Buy ${numberOfTicket} tickets`}
                        </Button>
                    </Grid>
                </Grid>
            </Paper>
