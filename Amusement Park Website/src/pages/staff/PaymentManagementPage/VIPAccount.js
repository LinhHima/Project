...
const VIPAccount = () => {
    ...
    const handleSellTicketVIP = async (e) => {
        try {
            ...
            setLoading(true);
            const response = await dp(sellTicketVIP({ code, eventCode, numberOfTicket, typeTicket, voucher }));
                ...
                <Grid container spacing={5}>
                    <Grid item xs={12} md={6}>
                        ...
                        <Typography style={{ fontSize: "larger" }}>
                            Point:{point}&nbsp;-&nbsp;Due Date: {dueDate.toLocaleString()}
                        </Typography>
                        ...
                        <form onSubmit={handleSellTicketVIP}>
                            ...
                            <Box textAlign="center">
                                <Button variant="contained" disabled={loading} type="submit">
                                    {loading ? <BeatLoader color="#fff" size={8} /> : "Sell ticket"}
                                </Button>
                            </Box>
                        </form>
                        <Box py={1}></Box>
