    ...
    return (
        <CustomClass>
            ...
            <Typography className="title">
                Turn ticket: {<FormattedNumber value={turnPriceCommon} />} VNĐ / 2h
            </Typography>
            <Typography className="title">
                Day ticket: {<FormattedNumber value={dayPriceCommon} />} VNĐ / 1day
            </Typography>
            ...
            {imgPaidGame.length > 0 ? (
                ...
                <Box py={3} textAlign="center">
                    <Empty color="green" title="There is no Common Game available now!!" />
                </Box>
            )}
            ...
            {imgPaidGame.length > 0 ? (
                ...
                <Box py={3} textAlign="center">
                    <Empty color="green" title="There is no Paid Game available now!!" />
                </Box>
            )}
